    ...
    <>
      ...
      <div className="home-container">
        ...
        <p className="home-para">
          As a software developer, my ultimate objective is to transform concepts into pleasurable and useful user experiences. 
          <br />I have strong experience working with complex business problems and creating unique solutions.
        </p>
        <div className="icons">
          <a href="https://www.linkedin.com/in/kesava-katammagari" target="_blank" rel="noopener noreferrer" className="icon-link">
            <FaLinkedin className="icon common-icon" />
          </a>
          <a href="https://github.com/Kesava123456" target="_blank" rel="noopener noreferrer" className="icon-link">
