        ...
        <div className="divide">
          <div className="left">
            ...
            <p className='para'>
              ...
              I designed and executed test cases for payroll processing modules, ensuring compliance with statutory regulations and organizational requirements.
              <br />
              <ul>
                <li>
                Beyond my QA expertise, I have a strong passion for <span className="spaan"> Frontend & Web Development.</span>
              Over the years, I have gained extensive experience building websites,
